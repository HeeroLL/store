 ...
 */
@Component("wmqDocSubConsumer")
public class WmqDocSubConsumer 
//extends SampleFramework
{
	private static final Log log = LogFactory.getLog(WmqDocSubConsumer.class);
...
//					subMsgService.handleSubMsg(messageText);
//					break;
