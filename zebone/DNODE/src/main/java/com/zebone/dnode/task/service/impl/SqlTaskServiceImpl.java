...
@Service("sqlTaskService")
public class SqlTaskServiceImpl extends BaseTaskService implements TaskService {
	
	private static final Logger logger = LoggerFactory.getLogger(SqlTaskServiceImpl.class); 
