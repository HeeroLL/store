...
import com.zebone.dnode.task.job.EtlJob;
import com.zebone.dnode.task.service.TaskService;
import com.zebone.dnode.task.util.DNJobKey;

@Service("etlTaskService")
public class EtlTaskServiceImpl extends BaseTaskService implements TaskService {
    
	private static final Logger logger = LoggerFactory.getLogger(EtlTaskServiceImpl.class); 
	...
	public void executeTask(Task task, TaskOp op) {
		// TODO Auto-generated method stub
	    Class<EtlJob> jobClass = EtlJob.class;
