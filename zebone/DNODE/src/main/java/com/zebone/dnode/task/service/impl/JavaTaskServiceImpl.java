...
import com.zebone.dnode.task.job.JavaJob;
import com.zebone.dnode.task.service.TaskService;
import com.zebone.dnode.task.util.DNJobKey;

@Service("javaTaskService")
public class JavaTaskServiceImpl extends BaseTaskService implements TaskService {
	...
	public void executeTask(Task task, TaskOp op) {
		// TODO Auto-generated method stub
		Class<JavaJob> jobClass = JavaJob.class;
	...
	private JobDataMap getJobMapPara(Task task){
		...
		jdm.put(DNJobKey.JAVA_ENGINE_SERVICE, javaEngineService);
		return jdm;
	}
