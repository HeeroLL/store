...
import com.zebone.dnode.task.job.OtherJob;
import com.zebone.dnode.task.service.TaskService;
import com.zebone.dnode.task.util.DNJobKey;

@Service("otherTaskService")
public class OtherTaskServiceImpl extends BaseTaskService implements TaskService {
	
	private static final Logger logger = LoggerFactory.getLogger(OtherTaskServiceImpl.class); 
	...
	public void executeTask(Task task, TaskOp op) {
		// TODO Auto-generated method stub
		Class<OtherJob> jobClass = OtherJob.class;
