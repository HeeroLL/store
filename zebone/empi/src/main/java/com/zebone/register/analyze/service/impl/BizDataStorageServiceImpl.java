package com.zebone.register.analyze.service.impl;
...
import com.zebone.register.analyze.excption.AnalyzeException;

import com.zebone.register.analyze.dao.InsertDataDao;
...
public class BizDataStorageServiceImpl implements BizDataStorageService{
	...
	public void saveToDataBase(List<AnalyzeDataInfo> analyzeDataList,String  docOpeCode){
		for(AnalyzeDataInfo info : analyzeDataList){
			...
			if(docOpeCode.equals(OpeType.DATA_UPDATE.getErrorCode())||docOpeCode.equals(OpeType.DATA_DELETE.getErrorCode())){
				// 删除老的数据
				try {
			...
			if(docOpeCode.equals(OpeType.DATA_UPDATE.getErrorCode())||docOpeCode.equals(OpeType.DATA_INSERT.getErrorCode())){
