...
public interface EmpiService {
    ...
    /**
     * 根据查询条件获取EMPI信息,适用于一卡通服务
     * @param paramXml
     * @return xml格式字符串
     */
    public String getEmpiInfo(@WebParam(name="paramXml")String paramXml)  throws Exception;
     ...
     * @return xml格式字符串
     */
    public String cancelCard(@WebParam(name="paramXml")String paramXml) throws Exception;
     ...
     * @return xml格式字符串
     */
    public String changeCardLevel(@WebParam(name="paramXml")String paramXml) throws Exception;
     ...
     * @return xml格式字符串
     */
    public String applyForUpdate(@WebParam(name="paramXml")String paramXml) throws Exception;
     ...
     * @return xml格式字符串
     */
    public String applyForUnbind(@WebParam(name="paramXml")String paramXml) throws Exception;
}
