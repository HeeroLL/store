...
public class ResourceUser {
	 ...
	 * 政治面貌
	 */
	private String poloticalStatusCode;
	...
	public String getMartialStatusCode() {
		return martialStatusCode;
	}

	public void setMartialStatusCode(String martialStatusCode) {
		this.martialStatusCode = martialStatusCode;
	}
	...
	public String getPoloticalStatusCode() {
		return poloticalStatusCode;
	}

	public void setPoloticalStatusCode(String poloticalStatusCode) {
		this.poloticalStatusCode = poloticalStatusCode;
	}
	...
	public String getDergree() {
		return dergree;
	}

	public void setDergree(String dergree) {
		this.dergree = dergree;
	}
