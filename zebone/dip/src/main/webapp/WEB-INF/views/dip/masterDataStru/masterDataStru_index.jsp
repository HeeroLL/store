...
<head>
    ...
    <script type="text/javascript" src="js/jsp/dip/masterDataStru/masterdatatru_index.js"></script>
    <style type="">
...
<div class="ui-layout-north">
	<div class="container">
	    ...
	    <!-- 容器标题部分 -->
		    <span class="title-l">
				<span class="title-r">
					<b class="icon"></b><span class="title-span">主数据结构查询</span>
				</span>
			</span>
	    ...
	    <div class="c_w">
	        <div class="c_e">
	            <div class="c_content">
	                <table id="query">
	                    <tr>
	                        <td>主数据名称：<input type="text" name="name"/></td>
	                        <td>主数据描述：<input type="text" name="comment"/></td>
	                        <td>
