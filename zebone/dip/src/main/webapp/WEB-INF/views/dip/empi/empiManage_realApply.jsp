...
<head>
    ...
    <script type="text/javascript" src="js/jsp/dip/empi/empiManage_realApply.js"></script>
    <style type="">
...
<div class="ui-layout-north">
    <div class="container">
        ...
        <!-- 容器标题部分 -->
		    <span class="title-l">
				<span class="title-r">
					<b class="icon"></b><span class="title-span">EMPI实名信息更新</span>
				</span>
			</span>
                ...
                <div class="c_content">
                    <table id="query">
                        <tr>
                            ...
                            <td>身份证号：<input type="text" name="cardNo"/></td>
