...
<body class="easyui-layout"> 
    <div style="padding:5px;" data-options="region:'north'">
    	...
    	<a href="#" onclick="toPage('../notice/publicNoticeIndex.zb')" class="easyui-linkbutton" 
    		data-options="plain:true,group:'btn',toggle:true,selected:true">公告</a>
    </div>
    <div data-options="region:'center'">
    	<iframe id="frm" name="frm" 
    		src="../notice/publicNoticeIndex.zb" height="100%" width="100%" scrolling="auto" frameborder="0"></iframe>
    </div>
</body>
</html>
