...
<body>
<div id="centerDiv" class="ui-layout-center">
              ...
              <div class="c_w">
              	<div class="c_e">
					...
					<form id="style_query_form">
						<table id="queryType" border="0" cellpadding="1" cellspacing="1" align="center" style="float: left;margin-top: 5px;">
                                  <tr>
                                      <!-- 
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;类型编码：</td>
                                      <td><input id="query_type_code" name="type_code" type="text" style="width: 90px;" maxlength="64" /></td>
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;类型名称：</td>
                                      <td>
                                          <input id="query_type_name" name="type_name" type="text" style="width: 90px;" maxlength="64" />
                                      </td>
                                       -->
                                       <td><span style="margin-left: 25px;"></span> <input type="text" style="width: 200px;" value="编码或名称" id="query_type_name" name="type_name" onblur="lostFocus(this);" onfocus="getFocus(this);"/> </td>
                                      <td>
...
<div class="ui-layout-east" style="overflow:auto;">
   	<!-- 列表界面 -->
...
<div class="ui-layout-west" style="overflow:auto;">
	...
	<div class="container" style="overflow:auto;">
    	...
    	<!-- 容器标题部分 -->
   		<span class="title-l">
			<span class="title-r">
				<b class="icon"></b><span class="title-span">字典目录</span>
			</span>
		</span>
