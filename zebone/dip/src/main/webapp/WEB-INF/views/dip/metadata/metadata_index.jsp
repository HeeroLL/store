...
<script type="text/javascript" src="js/jsp/dip/metadata/metadata_index.js"></script>
<style type="">
...
<div class="container">
	...
	<span class="title-l">
		<span class="title-r">
			<b class="icon"></b><span class="title-span">数据元查询</span>
		</span>
	</span>
	...
	<div class="c_w">
		<div class="c_e">
			<div class="c_content">
				<table id="query">
					<tr>
						<td>标识符：<input type="text" name="fieldId" maxlength="32"/> </td>
						<td>名称：<input type="text" name="fieldName" maxlength="32"/> </td>
						<td>目录分类：<select name="onlySort">
