...
<head>
    ...
    <script type="text/javascript" src="js/jsp/dip/resources/familyInfo.js"></script>
	<style type="text/css">
        html,body{
...
<div class="container">
    ...
    <span class="title-l">
		<span class="title-r">
			<b class="icon"></b><span class="title-span">家庭档案查询</span>
		</span>
	</span>
           ...
           <div class="c_e">
               <div class="c_content">
                   <table id="query">
                       <tr>
                       	<td>
                       	&nbsp;&nbsp;&nbsp;户主姓名： <input type="text" name="householdName"  style="width: 100px;" />
                       	</td>
                       	<td>
                       	&nbsp;&nbsp;&nbsp;家庭地址： <input type="text" name="familyAddr"  style="width: 100px;" />
                       	</td>
                        <td>
                        &nbsp;&nbsp;&nbsp;
