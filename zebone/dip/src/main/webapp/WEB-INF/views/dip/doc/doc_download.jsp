...
<script type="text/javascript" src="js/jsp/dip/doc/doc_index.js"></script>
<style type="">
		...
		<div class="c_e">
			<div class="c_content">
				<table id="query" border="0" cellpadding="1" cellspacing="1" align="center" style="float: left">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;文档名称：</td>
						<td><input id="docName" name="docName" type="text" style="width: 110px;" maxlength="64"/></td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;版本名称：</td>
						<td>
	...
	<form id="checkForm" action="" class="checkForm">
		<div class="container">
			...
			<div class="c_content">
            	<table>
                   	<tr>
                   		<td>文档名称：<input type="hidden" id="id" name="id" value=""/></td>
