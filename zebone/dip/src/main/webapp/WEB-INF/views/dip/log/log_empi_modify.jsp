...
var col = [{text: '时间', width: 130, textAlign: 'center',	align : 'center', dataIndex: 'eventTime' },
			{text: '机构', width: 100, textAlign: 'center',	align : 'center', dataIndex: 'orgName' },
...
$(function(){
	grid = new JGrid({
		...
		dataUrl  : 'log/empiUpdateoradd.zb',
		render   : 'grid',
		pageBar  : true,
		crudOpera: false,
		countEveryPage: 15
...
<div class="container">
	...
	<span class="title-l">
		<span class="title-r">
			<b class="icon"></b><span class="title-span">EMPI注册与更新</span>
		</span>
	</span>
