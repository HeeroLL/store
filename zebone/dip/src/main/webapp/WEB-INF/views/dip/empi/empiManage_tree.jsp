...
<head>
    ...
    <script type="text/javascript">
        ...
        var nodes = [
            {id:"1",pId:"0",name:"主索引查询"},
            {id:"2",pId:"0",name:"主索引统计"},
            {id:"3",pId:"0",name:"EMPI解绑"},
            {id:"4",pId:"0",name:"实名信息更新"}
        ];
        ...
        function onClicktree(str){
            if(str ==1){
                window.parent.document.getElementById("innerMainFrame").src = "empiManage/query.zb";//主索引信息查询
            }else if(str ==2){
                window.parent.document.getElementById("innerMainFrame").src = "empiManage/count.zb";//主索引信息统计
            }else if(str ==3){
                window.parent.document.getElementById("innerMainFrame").src = "empiManage/unbindApplyInfo.zb";//主索引信息统计
            }else if(str ==4){
                window.parent.document.getElementById("innerMainFrame").src = "empiManage/realApplyInfo.zb";//实名更新申请信息
            }
        }
...
<div class="container" style="width:210px;margin-left: 10px;">
	...
	<span class="title-l" style="padding-left:4px;">
		<span class="title-r">
			<b class="icon"></b><span class="title-span">主索引管理系统</span>
		</span>
	</span>
