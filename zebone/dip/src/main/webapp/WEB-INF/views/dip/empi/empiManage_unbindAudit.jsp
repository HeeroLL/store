...
<table style="width:95%;margin-bottom: 20px;border-collapse:collapse;" align="center" >
    <tr style="height: 32px"><td colspan="7" align="center">${unbindApply.secCardType}：${unbindApply.secCardNo}</td></tr>
    <tr style="height: 32px">
        ...
        <td width="120" rowspan="6">
            <div align="center">
                <img src="data:image/png;base64,${unbindApply.strPhoto}"/>
            </div>
        </td>
        <td width="130" align="center">姓名</td>
        <td width="200" align="center">${unbindApply.name}</td>
    </tr>
    <tr>
        <td align="center">证件类型</td>
        <td align="center">${oldFirstCard.cardType}</td>
        <td align="center">证件类型</td>
        <td align="center">${unbindApply.firstCardType}</td>
    </tr>
    <tr>
        <td align="center">证件号</td>
        <td align="center">${oldFirstCard.cardNo}</td>
        <td align="center">证件号</td>
        <td align="center">${unbindApply.firstCardNo}</td>
    </tr>
    <tr>
        <td align="center">性别</td>
        <td align="center">${empiInfo.sex}</td>
        <td align="center">性别</td>
        <td align="center">${unbindApply.sex}</td>
    </tr>
    <tr>
        <td align="center">出生日期</td>
        <td align="center">${empiInfo.strBirthday}</td>
        <td align="center">出生日期</td>
        <td align="center">${unbindApply.strBirthday}</td>
    </tr>
    <tr>
        <td align="center">民族</td>
        <td align="center">${empiInfo.nation}</td>
        <td align="center">民族</td>
        <td align="center">${unbindApply.nation}</td>
    </tr>
    <tr>
        <td align="center">户籍地址</td>
        <td colspan="2" align="center">${empiInfo.permanentAddress}</td>
        <td align="center">户籍地址</td>
        <td colspan="2" align="center">${unbindApply.permanentAddress}</td>
    </tr>
</table>
...
<form id="auditForm" action="" class="checkForm">
    <div style="width:95%;margin-left: 20px;border-collapse:collapse; display: inline">
        ...
        <input type="hidden" id="id" name="id" value="${unbindApply.id}">
        <input type="hidden" id="oldCardNo" name="oldCardNo" value="${oldFirstCard.cardNo}"/>
        <input type="hidden" id="oldCardType" name="oldCardType"  value="${oldFirstCard.cardType}"/>
        <input type="hidden" id="firstCardNo" name="firstCardNo" value="${unbindApply.firstCardNo}"/>
        <input type="hidden" id="firstCardType" name="firstCardType" value="${unbindApply.firstCardType}"/>
        <input type="hidden" id="secCardType" name="secCardType" value="${unbindApply.secCardType}"/>
        <input type="hidden" id="secCardNo" name="secCardNo" value="${unbindApply.secCardNo}"/>
    </div>
</form>
