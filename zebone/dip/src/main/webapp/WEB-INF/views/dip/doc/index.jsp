    ...
    <script type="text/javascript">
	  //加载完成，执行以下代码
	    $(function(){
	    	...
	    	window.document.getElementById("innerMainFrame").src = "doc/docDownload.zb";//文档下载管理
	    });
    </script>
</head>
...
<div class="ui-layout-west">
    <iframe src="doc/docTree.zb" name="innerlLeftFrame" style="height:100%;" scrolling="no" frameborder="0"
