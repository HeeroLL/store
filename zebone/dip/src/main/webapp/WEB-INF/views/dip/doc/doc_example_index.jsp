...
<div class="ui-layout-west">
    <iframe src="doc/docTypeTree.zb" name="innerlLeftFrame" style="height:100%;" scrolling="no" frameborder="0" noresize="noresize" id="innerlLeftFrame" title="innerlLeftFrame"></iframe>
</div>
