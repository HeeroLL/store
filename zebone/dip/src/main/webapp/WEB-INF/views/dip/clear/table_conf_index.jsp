...
<script type="text/javascript" src="js/jsp/dip/clear/table_conf_index.js"></script>
<style type="">
			...
			<div class="c_content">
				<table id="query">
					<tr>
						...
						<td>表类型：<select name="tableType">
							<option value="-1">请选择</option>
							<option value="1">源数据层</option>
							<option value="2">报表层</option>
						</select> </td>
						<td>
