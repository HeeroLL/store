...
<head>
    ...
    <script type="text/javascript" src="js/jsp/dip/resources/userInfo.js"></script>
	<style type="text/css">
        html,body{
...
<div class="container">
    ...
    <span class="title-l">
		<span class="title-r">
			<b class="icon"></b><span class="title-span">人员查询</span>
		</span>
	</span>
           ...
           <div class="c_e">
               <div class="c_content">
                   <table id="query">
                       <tr>
                       	<td>
                       	&nbsp;&nbsp;&nbsp;姓名： <input type="text" name="name"  style="width: 80px;" />
                       	</td>
                       	<td>
                       	&nbsp;&nbsp;岗位： 
                       	<select name="postCode"   style="width: 80px;" >
                       	...
                       	<td>
                       	&nbsp;&nbsp;科室： <input type="text" name="deptName" id="deptName" style="width: 100px;"/><input type="hidden" name="departmentCode"/>
                       	</td>
                        <td>
                        &nbsp;&nbsp;&nbsp;
