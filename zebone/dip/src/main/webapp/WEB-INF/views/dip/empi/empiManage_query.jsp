...
<head>
    ...
    <script type="text/javascript" src="js/jsp/dip/empi/empiManage_query.js"></script>
    <style type="">
...
<div class="ui-layout-north">
    <div class="container">
        ...
        <!-- 容器标题部分 -->
		    <span class="title-l">
				<span class="title-r">
					<b class="icon"></b><span class="title-span">主索引信息查询</span>
				</span>
			</span>
                ...
                <div class="c_content">
                    <table id="query">
                        <tr>
                            ...
                            <td>发卡机构：
                                <input type="text" name="cardOrg" id="cardOrg" />
                            </td>
                            <td>
