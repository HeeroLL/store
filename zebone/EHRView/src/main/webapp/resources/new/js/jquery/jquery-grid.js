 ...
 */
 ...
 JGrid.prototype = {
 	...
 	setOperButtons:function(){
 		var b=new Array();
 		b.push("<a href='javascript:void(0);' class='btn btn-plain' name='add'><span class='btn-left'><span class='btn-text btn-icon-left icon-add'>新 建</span></span></a>");
 		b.push("<span class='btn-plain-separator'></span>");
 		b.push("<a href='javascript:void(0);' class='btn btn-plain' name='update'><span class='btn-left'><span class='btn-text btn-icon-left icon-edit'>修 改</span></span></a>");
 		b.push("<span class='btn-plain-separator'></span>");
 		b.push("<a href='javascript:void(0);' class='btn btn-plain' name='remove'><span class='btn-left'><span class='btn-text btn-icon-left icon-remove'>删 除</span></span></a>");
 		b.push("<span class='btn-plain-separator'></span>");
 		b.push("<a href='javascript:void(0);' class='btn btn-plain' name='refresh'><span class='btn-left'><span class='btn-text btn-icon-left icon-reload'>刷 新</span></span></a>");
 		this.jgridToolBar.append(b.join(''));
