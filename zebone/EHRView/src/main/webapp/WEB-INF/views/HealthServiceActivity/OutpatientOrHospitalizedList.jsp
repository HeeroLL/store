			...
			<table width="100%" class="jgridDataTable">
				...
				<c:forEach items="${adultsHealthExamList}" var="object" varStatus="status">
					<tr class="data">
						...
						<td align="center">${object.department}</td>
						<td align="center"><a href="index_right_mzxq.html"><a href="${url}?empiId=${empiId}&dataCode=${object.code}&docNo=${object.docNo}&searchInfo=${searchInfo}&patientInfo=${patientInfo}">详情</a></a></td>
					</tr>	
				</c:forEach>
