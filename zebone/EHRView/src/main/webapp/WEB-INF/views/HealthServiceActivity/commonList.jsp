...
$(function(){
	...
	if(datacode=="C00.01.02.00"||datacode=="C00.02.01.00"){
...
<div class="j-panel j-panel-radius j-panel-nohead" id="" style="padding:5px;min-height:648px;">
		<div class="j-panel-body" id="" style="">
			<div  class="position">
				当前位置：卫生服务活动-->${serviceName}--><span style="color: #0000ff">${title}</span>
			</div>
			<table width="100%" class="jgridDataTable">
				<tr class="header">
					...
					<th class="office">${clinicDept}</th>
					<th>详情链接</th>
				</tr>
				<c:forEach items="${commonList}" var="object" varStatus="status">
					<tr class="data">
						<td align="center">${object.time}</td>
						<td align="center">${object.doctor}</td>
						<td align="center">${object.org}</td>
						<td align="center" class="office">${object.office}</td>
						<td align="center"><a href="${url}?empiId=${empiId}&dataCode=${dataCode}&docNo=${object.code}&searchInfo=${searchInfo}&patientInfo=${patientInfo}">详情</a></td>
					</tr>	
				</c:forEach>
