	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">卫生服务活动—>老年人保健随访记录</div>
			</div>
			<div id="JGrid-9b4d6-headerAndDataDiv" class="jHeaderAndDataDIV" style="height: auto;">
				<div class="jHeaderDIV">
					<table id="JGrid-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						<tr class="header" name="header">
							...
							<td width="100"  style="text-align:center;width:150px" name="maxicon"><div class="headerTdDiv">随访日期<span value="0"></span></div></td>
							<td width="100"  style="text-align:center;width:150px" name="orderNo"><div class="headerTdDiv">随访医生<span value="0"></span></div></td>
							<td width="110"  style="text-align:center;width:210px" name="moduleName"><div class="headerTdDiv">服务机构<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 200px;" name="url"><div class="headerTdDiv">规范随访标志<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 200px;" name="url"><div class="headerTdDiv">建议内容<span value="0"></span></div></td>
				...
				<div id="JGrid-85a5b-dataDiv" class="jgridDataDIV" style="height: 450px;">
					<table cellspacing="1" cellpadding="0" border="0" id="JGrid-dataTable">
						<c:forEach items="${oldersFollowupList}" var="object" varStatus="status">
						    <tr index="1" name="data" class="data">
								...
								<td align="center" title="1" selects="0" style="width: 150px;">${object.doctor}</td>
								<td align="center" title="moduleName1" selects="0" style="width: 210px;">${object.org}</td>
								<td align="center" title="url1" selects="0" style="width: 200px;">${object.ruleFollowupFlag}</td>
								<td align="center" title="url1" selects="0" style="width: 200px;">${object.suggest}</td>
								<td align="center" title="url1" selects="0" style="width: 100px;"><a href="healthCareDetails.zb?empiId=${empiId}&dataCode=${dataCode}&docNo=${object.code}
								">详情</a></td>
							</tr>
						</c:forEach>
					</table>
