	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">卫生服务活动</div>
			</div>
				...
				<div class="jHeaderDIV">
					<table id="JGrid-9b4d6-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						<tr class="header" name="header">
							...
							<td width="100"  style="text-align:center;width:170px" name="maxicon"><div class="headerTdDiv">随访日期<span value="0"></span></div></td>
							<td width="100"  style="text-align:center;width:170px" name="orderNo"><div class="headerTdDiv">随访医生<span value="0"></span></div></td>
							<td width="110"  style="text-align:center;width:180px" name="moduleName"><div class="headerTdDiv">服务机构<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 170px;" name="url"><div class="headerTdDiv">健康评价标志<span value="0"></span></div></td>
