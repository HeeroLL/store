		...
		<div class="j-panel-body" id="" style="">
			...
			<table width="100%" class="jgridDataTable">
				...
				<c:forEach items="${adultsHealthExamList}" var="object" varStatus="status">
					<tr class="data">
						<td align="center">${object.date}</td>
						<td align="center">${object.doctor}</td>
						<td align="center">${object.org}</td>
						<td align="center">${object.healthFlag}</td>
						<td align="center">${object.healthGuide}</td>
						<td align="center"><a href="healthProblemDetails.zb?empiId=${empiId}&dataCode=${object.code}&docNo=${object.docNo}&searchInfo=${searchInfo}&patientInfo=${patientInfo}">详情</a></td>
					</tr>	
				</c:forEach>
