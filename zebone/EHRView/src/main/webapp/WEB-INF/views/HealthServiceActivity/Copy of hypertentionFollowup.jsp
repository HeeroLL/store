...
<script type="text/javascript">
    //跳转到高血压专档页面
    function hypertensionRep() {
        var empiId = '${empiId}';
        var dataCode1 = '${dataCode1}';
        window.location.href = "hypertensionRep.zb?empiId=" + empiId + "&dataCode=" + dataCode1;
    }
	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">卫生服务活动—><a href="javascript:hypertensionRep();">高血压专档</a> &gt;&gt; 随访记录</div>
			</div>
				...
				<div class="jHeaderDIV">
					<table id="JGrid-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						<tr class="header" name="header">
							<%--<td style="text-align:center;width:100px" name="maxicon"><div class="headerTdDiv">序号<span value="0"></span></div></td>--%>
					...
					<table cellspacing="1" cellpadding="0" border="0" id="JGrid-dataTable">
						<c:forEach items="${hypertensionList}" var="object" varStatus="status">
						    <tr index="1" name="data" class="data">
								...
								<td align="center" title="url1" selects="0" style="width: 160px;"><a href="hypertensionDetails.zb?empiId=${empiId}&dataCode=${dataCode}&docNo=${object.code}">详情</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
