	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">卫生服务活动—>成人健康体检记录</div>
			</div>
			<div id="JGrid-9b4d6-headerAndDataDiv" class="jHeaderAndDataDIV" style="height: auto;">
				<div class="jHeaderDIV">
					<table id="JGrid-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						<tr class="header" name="header">
							...
							<td width="100"  style="text-align:center;width:170px" name="maxicon"><div class="headerTdDiv">体检日期<span value="0"></span></div></td>
							<td width="100"  style="text-align:center;width:170px" name="orderNo"><div class="headerTdDiv">责任医生<span value="0"></span></div></td>
							<td width="110"  style="text-align:center;width:180px" name="moduleName"><div class="headerTdDiv">服务机构<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 170px;" name="url"><div class="headerTdDiv">健康评价异常标志<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 170px;" name="url"><div class="headerTdDiv">健康指导<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 100px;" name="url"><div class="headerTdDiv">操作<span value="0"></span></div></td>
						</tr>
					</table>
				</div>
				<div id="JGrid-85a5b-dataDiv" class="jgridDataDIV" style="height: 450px;">
					<table cellspacing="1" cellpadding="0" border="0" id="JGrid-dataTable">
						<c:forEach items="${adultsHealthExamList}" var="object" varStatus="status">
						    <tr index="1" name="data" class="data">
						    	<%--<td align="center" title="maxicon1" selects="0" style="width: 100px;">${status.index+1}</td>--%>
								<td align="center" title="maxicon1" selects="0" style="width: 170px;">${object.date}</td>
								<td align="center" title="1" selects="0" style="width: 170px;">${object.doctor}</td>
								<td align="center" title="moduleName1" selects="0" style="width: 180px;">${object.org}</td>
								<td align="center" title="url1" selects="0" style="width: 170px;">${object.healthFlag}</td>
								<td align="center" title="url1" selects="0" style="width: 170px;">${object.healthGuide}</td>
								<td align="center" title="url1" selects="0" style="width: 100px;"><a href="healthCheck.zb?empiId=${empiId}&dataCode=${dataCode}&docNo=${object.code}">详情</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
