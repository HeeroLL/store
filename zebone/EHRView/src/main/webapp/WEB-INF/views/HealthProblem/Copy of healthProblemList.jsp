	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">健康和疾病问题—>${healthName}</div>
			</div>
				...
				<div class="jHeaderDIV">
					<table id="JGrid-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						...
						<tr class="header" name="header">
							<td style="text-align:center;width:50px" name="maxicon"><div class="headerTdDiv">序号</div></td>
							<td style="text-align:center;width:150px" name="maxicon"><div class="headerTdDiv">时间</div></td>
							<td style="text-align:center;width:200px" name="orderNo"><div class="headerTdDiv">生命阶段</div></td>
							<td style="text-align:center;width:210px" name="moduleName"><div class="headerTdDiv">卫生服务活动</div></td>
							<td style="text-align:center;width:250px" name="url"><div class="headerTdDiv">详情</div></td>
						</tr>
					</table>
				</div>
					...
					<table cellspacing="1" cellpadding="0" border="0" id="JGrid-dataTable">
						<c:forEach items="${healthProblemList}" var="object" varStatus="status">
						    <tr index="1" name="data" class="data">
								...
								<td align="center" title="url1" selects="0" style="width: 250px;"><a href="healthProblemDetails.zb?empiId=${empiId}&dataCode=${object.docNo}&docNo=${object.code}&searchInfo=${searchInfo}&patientInfo=${patientInfo}">查看</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
