	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">生命阶段</div>
			</div>
			<div id="JGrid-9b4d6-headerAndDataDiv" class="jHeaderAndDataDIV" style="height: auto;">
				<div class="jHeaderDIV">
					<table id="JGrid-9b4d6-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						<tr class="header" name="header">
							<td width="100"  style="text-align:center;width:50px" name="maxicon"><div class="headerTdDiv">序号<span value="0"></span></div></td>
							<td width="100"  style="text-align:center;width:150px" name="maxicon"><div class="headerTdDiv">时间<span value="0"></span></div></td>
							<td width="100"  style="text-align:center;width:200px" name="orderNo"><div class="headerTdDiv">健康疾病问题<span value="0"></span></div></td>
							<td width="110"  style="text-align:center;width:210px" name="moduleName"><div class="headerTdDiv">卫生服务活动<span value="0"></span></div></td>
							<td width="150"  style="text-align: center; width: 250px;" name="url"><div class="headerTdDiv">详情<span value="0"></span></div></td>
						</tr>
					</table>
				</div>
				<div id="JGrid-85a5b-dataDiv" class="jgridDataDIV" style="height: 450px;">
					<table cellspacing="1" cellpadding="0" border="0" id="JGrid-85a5b-dataTable">
						<c:forEach items="${lifePeriodList}" var="object" varStatus="status">
						    <tr index="1" name="data" class="">
								...
								<td align="center" title="maxicon1" selects="0" style="width: 200px;">${object.healthPro}</td>
								<td align="center" title="moduleName1" selects="0" style="width: 210px;">${object.healthActivity}</td>
								<td align="center" title="url1" selects="0" style="width: 250px;"><a href="hypertensionDetails.zb?empiId=${empiId}&dataCode=${object.code}&docNo=${object.docNo}">查看</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
