			...
			<table width="100%" class="jgridDataTable">
				...
				<c:forEach items="${lifePeriodList}" var="object" varStatus="status">
					<tr class="data">
						...
						<td align="center">${object.healthPro}</td>
						<td align="center">${object.healthActivity}</td>
						<td align="center"><a href="index_right_mzxq.html"><a href="healthProblemDetails.zb?empiId=${empiId}&dataCode=${object.code}&docNo=${object.docNo}&searchInfo=${searchInfo}&patientInfo=${patientInfo}">查看</a></a></td>
					</tr>	
				</c:forEach>
