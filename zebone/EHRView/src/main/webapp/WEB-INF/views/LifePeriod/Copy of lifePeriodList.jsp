	...
	<div id="JGrid" class="jgridDIV" >
		<div id="JGrid-9b4d6-main" class="jgridMain" style="">
			<div id="JGrid-9b4d6-header" class="j-panel-header">
				<div class="j-panel-title">生命阶段—>${periodName}</div>
			</div>
				...
				<div class="jHeaderDIV">
					<table id="JGrid-headerTable" class="jgridHeaderTable" cellspacing="0" cellpadding="0" border="0" >
						<tr class="header" name="header">
							...
							<td style="text-align:center;width:200px" name="orderNo"><div class="headerTdDiv">健康疾病问题<span value="0"></span></div></td>
					...
					<table cellspacing="1" cellpadding="0" border="0" id="JGrid-dataTable">
						<c:forEach items="${lifePeriodList}" var="object" varStatus="status">
						    <tr index="1" name="data" class="data">
								...
								<td align="center" title="url1" selects="0" style="width: 250px;"><a href="healthProblemDetails.zb?empiId=${empiId}&dataCode=${object.code}&docNo=${object.docNo}&searchInfo=${searchInfo}&patientInfo=${patientInfo}">查看</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
