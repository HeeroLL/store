...
<head>
    ...
    <script type="text/javascript">
        ...
        function hypertensionFollow() {
            var empiId = '${empiId}';
            window.location.href = "hypertentionFollowup.zb?empiId=" + empiId;
        }
...
<div class="j-panel j-panel-radius j-panel-nohead" style="padding:5px;min-height:648px;overflow:auto;">
    <div class="j-panel-body" style="">
        <div class="position">当前位置：卫生服务活动-->疾病管理--><span style="color: #0000ff">高血压报卡</span></div>
        <%--<div id="scroll" style="top:120px">--%>
            <%--<ul>--%>
                <%--<li style="width: 50px"><a href="javascript:void(0);" to="#baseInfo">基本信息</a></li>--%>
                <%--<li style="width: 50px"><a href="javascript:void(0);" to="#patientInfo">患者信息</a></li>--%>
                <%--<li style="width: 50px"><a href="javascript:void(0);" to="#detailInfo">高血压详细情况</a></li>--%>
                <%--<li style="width: 50px"><a href="javascript:void(0);" to="#complication">并发症情况</a></li>--%>
            <%--</ul>--%>
        <%--</div>--%>
        ${htmlValue}
    </div>
