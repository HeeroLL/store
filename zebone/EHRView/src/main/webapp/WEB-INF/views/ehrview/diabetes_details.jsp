...
<head>
    ...
    <script type="text/javascript">
        //跳转到糖尿病随访列表页面
        function diabetesFollow() {
            var empiId = '${empiId}';
            var searchInfo = '${searchInfo}';
            var patientInfo = '${patientInfo}';
            window.location.href = "healthActivityCommonList.zb?empiId="+empiId+"&dataCode=B04.02.02.00" + "&searchInfo=" + searchInfo + "&patientInfo=" + patientInfo;
        }
        ...
        var fixScroll=function(){
            ...
            var h=cHeight/2+t-iframeP.top-($('#scroll').height()/2)-100;
...
<div class="j-panel j-panel-radius j-panel-nohead" style="padding:5px;min-height:648px;overflow:auto;">
    <div class="j-panel-body" style="">
        <div class="position">当前位置：卫生服务活动-->疾病管理-->糖尿病报卡--><a style="color: #0000ff;text-decoration: underline" href="javascript:diabetesFollow()">糖尿病随访</a>--><span style="color: #0000ff">糖尿病随访详情</span></div>
